...
export function createInMemoryCharacters(): CharactersCapability {
  ...
  function create(partial: Partial<CharacterCard> = {}): CharacterCard {
    ...
    const card: CharacterCard = {
      ...
      postHistoryInstructions: partial.postHistoryInstructions ?? '',
      creator: partial.creator ?? '',
      alternateGreetings: partial.alternateGreetings ?? [],
      talkativeness: partial.talkativeness ?? 0,
      world: partial.world ?? '',
      depthPrompt: partial.depthPrompt ?? null,
      regexScripts: partial.regexScripts ?? [],
      characterBook: partial.characterBook ?? null,
